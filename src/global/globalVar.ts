...
export const META_TITLE = '미르';
export const META_DESCRIPTION = '미르크라우드';
export const META_KEYWORDS =
  '캐릭터,굿즈,다꾸,다꾸페,다이어리,일러스트,서일페,일러스트레이션,크라우드펀딩,트위터,펀딩,디자인';

export const META_BASE_URL = 'https://mircrowd.com/';
export const FB_APP_ID = '237186557304874';
export const TWITTER_USERNAME = 'mir_crowd';
